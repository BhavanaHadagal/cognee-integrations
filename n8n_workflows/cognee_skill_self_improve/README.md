...
```bash
export COGNEE_SELF_IMPROVE_WORKFLOW_ROOT="$PWD/n8n_workflows/cognee_skill_self_improve"
...
the relative fallback `./n8n_workflows/cognee_skill_self_improve`. If you start
n8n from another directory, set `COGNEE_SELF_IMPROVE_WORKFLOW_ROOT` to the
